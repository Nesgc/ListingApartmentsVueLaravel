<template>
    ...
    <main class="container mx-auto p-4">
        ...
        <div
            v-if="flashwarnings"
            class="mb-4 border rounded-md shadow-sm border-green-200 dark:border-red-800 bg-green-50 dark:bg-red-900 p-2"
        >
            {{ flashwarnings }}
        </div>
        <slot>Default</slot>
...
const page = usePage();
const flashwarnings = computed(() => page.props.flash.warnings);
